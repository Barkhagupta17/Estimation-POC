...
function ClientCustomChange({ view, setTab }) {
  ...
  return (
    <Box>
      ...
      <Button size="1.3rem" type="button" variant="contained" color="secondary" onClick={handleSave} sx={{ marginTop: '20px', visibility: view ? 'hidden' : 'visible' }}>
        Save
      </Button>
    </Box>
  );
